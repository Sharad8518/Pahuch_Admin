...
export default function ViewRuralProduct({navigation,route}) {
              ...
              loading ?
                ...
                <>
                  <View style={styles.body}>
                    ...
                    {data && data.getALLRuralById.map(product => {
                      return (
                        <TouchableOpacity onPress={() => navigation.navigate("RuralProductDetail", { userId: product.id })}>
